                ...
                <form method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data" class="verification-form" data-verification-form data-location-provinces-url="{{ route('profile.locations.provinces') }}" data-location-cities-url="{{ route('profile.locations.cities') }}" data-location-barangays-url="{{ route('profile.locations.barangays') }}">
                    ...
                    <section>
                        ...
                        <div class="verification-grid">
                            ...
                            <div class="field-group"><label for="nationality">Nationality</label><div class="searchable-combobox"><input id="nationality" name="nationality" type="search" list="nationality-options" autocomplete="off" placeholder="Search nationality…" value="{{ old('nationality', $profileUser->nationality) }}" required><span aria-hidden="true">⌄</span><datalist id="nationality-options">@foreach ($nationalities as $nationality)<option value="{{ $nationality }}"></option>@endforeach</datalist></div>@error('nationality')<p class="error-text">{{ $message }}</p>@enderror</div>
                    ...
                    <section>
                        ...
                        <div class="verification-grid">
                            ...
                            <div class="field-group"><label for="city">City / municipality</label><div class="searchable-combobox"><input id="city" name="city" type="search" list="city-options" autocomplete="off" placeholder="Select province first" value="{{ old('city', $profileUser->city) }}" required data-city-input><span aria-hidden="true">⌄</span><datalist id="city-options"></datalist></div>@error('city')<p class="error-text">{{ $message }}</p>@enderror</div>
                            <div class="field-group"><label for="barangay">Barangay</label><div class="searchable-combobox"><input id="barangay" name="barangay" type="search" list="barangay-options" autocomplete="off" placeholder="Select city first" value="{{ old('barangay', $profileUser->barangay) }}" required data-barangay-input><span aria-hidden="true">⌄</span><datalist id="barangay-options"></datalist></div><small class="field-help" data-location-status>Choose a country to load address suggestions.</small>@error('barangay')<p class="error-text">{{ $message }}</p>@enderror</div>
