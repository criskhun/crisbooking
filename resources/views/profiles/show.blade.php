        ...
        <main class="dashboard-main">
            ...
            <section class="public-profile-card">
                ...
                <div class="profile-validation-grid">
                    ...
                    <section><span class="eyebrow">Contact</span><dl><div><dt>Email</dt><dd>{{ $profileUser->email }}</dd></div><div><dt>Mobile</dt><dd>{{ $profileUser->phone }}</dd></div><div><dt>Address</dt><dd>{{ $profileUser->address }}, {{ $profileUser->city }}</dd></div></dl></section>
