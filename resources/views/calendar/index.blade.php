                            ...
                            @forelse ($selectedBookings as $booking)
                                <article class="day-booking-item">
                                    ...
                                    <div class="booking-details">
                                        ...
                                        <small>{{ $booking->isManualBooking() ? 'External: '.$booking->customerDisplayName().' · '.$booking->sourceDisplayLabel().' · '.$booking->durationDisplayLabel() : 'Client: '.$booking->customerDisplayName().($booking->rate_period ? ' · '.(['hour' => 'Hourly', '12_hours' => '12 hours', 'day' => '1 day', 'week' => '1 week', 'month' => '1 month'][$booking->rate_period] ?? $booking->rate_period) : '') }} · ₱{{ number_format($booking->total_amount, 2) }}</small>
