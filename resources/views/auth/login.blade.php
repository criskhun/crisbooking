...
@section('content')
    @php($isAndroidApp = Str::contains((string) request()->userAgent(), 'DavaoRentZoneAndroid/'))
    <main class="auth-shell">
        ...
        <section class="auth-form-panel">
            <div class="auth-form-wrap">
                ...
                @if(request()->filled('mobile_oauth_error'))
                    <div class="oauth-error" role="alert">{{ request()->string('mobile_oauth_error') }}</div>
                @endif

                <div class="social-buttons">
                    <a class="social-button google-button" href="{{ route('auth.google.redirect', $isAndroidApp ? ['mobile' => 'android'] : []) }}" @if($isAndroidApp) data-native-oauth data-no-loading @endif>
                    ...
                    <a class="social-button facebook-button" href="{{ route('auth.facebook.redirect', $isAndroidApp ? ['mobile' => 'android'] : []) }}" @if($isAndroidApp) data-native-oauth data-no-loading @endif>
