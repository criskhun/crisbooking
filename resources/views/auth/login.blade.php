        ...
        <section class="auth-form-panel">
            <div class="auth-form-wrap">
                ...
                <div class="social-buttons">
                    <a class="social-button google-button" href="{{ route('auth.google.redirect', $isAndroidApp ? ['mobile' => 'android'] : []) }}" @if($isAndroidApp) data-native-oauth @endif>
                    ...
                    <a class="social-button facebook-button" href="{{ route('auth.facebook.redirect', $isAndroidApp ? ['mobile' => 'android'] : []) }}" @if($isAndroidApp) data-native-oauth @endif>
