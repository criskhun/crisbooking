...
@section('title', 'Units & services — MyBooking')
                    ...
                    @forelse ($units as $unit)
                        ...
                        <article class="listing-card">
                            ...
                            @if ($unit->category === 'car' && $unit->car_details)
                                <div class="listing-detail-summary"><strong>{{ $unit->car_details['year'] ?? '' }} {{ $unit->car_details['make'] ?? '' }} {{ $unit->car_details['model'] ?? '' }}</strong><small>{{ ucfirst($unit->car_details['transmission'] ?? '') }} · {{ ucfirst($unit->car_details['fuel_type'] ?? '') }}</small></div>
