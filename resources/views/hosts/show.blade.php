        ...
        <section class="host-storefront-listings">
            ...
            <div class="host-listing-grid">
                @forelse($hostUser->units as $unit)
                    ...
                    <article>
                        <div class="host-listing-media">@include('partials.listing-card-carousel', ['carouselUnit' => $unit, 'carouselLinkClass' => 'host-listing-photo', 'carouselPlaceholder' => ['car' => '🚗', 'condo' => '🏢', 'cleaning' => '🧹', 'driving' => '🛞', 'massage' => '💆', 'consultancy' => '💬'][$unit->category] ?? '◇'])@if($unit->hasSale())<span class="listing-sale-badge">{{ number_format((float) $unit->sale_percentage, 0) }}% off</span>@endif @include('partials.listing-favorite', ['favoriteUnit' => $unit])</div>
