...
<aside class="sidebar" data-mobile-sidebar>
    <button class="sidebar-toggle" type="button" data-mobile-sidebar-toggle aria-controls="dashboard-navigation" aria-expanded="false">
        ...
        {{-- Font Awesome Free Solid: Bars and Xmark (CC BY 4.0). --}}
        <span class="sidebar-toggle-icon" aria-hidden="true">
            <svg class="sidebar-toggle-glyph sidebar-toggle-glyph-menu" viewBox="0 0 448 512" focusable="false">
                <path d="M0 96C0 78.3 14.3 64 32 64H416c17.7 0 32 14.3 32 32s-14.3 32-32 32H32C14.3 128 0 113.7 0 96zM0 256c0-17.7 14.3-32 32-32H416c17.7 0 32 14.3 32 32s-14.3 32-32 32H32c-17.7 0-32-14.3-32-32zM448 416c0 17.7-14.3 32-32 32H32c-17.7 0-32-14.3-32-32s14.3-32 32-32H416c17.7 0 32 14.3 32 32z"/>
            </svg>
            <svg class="sidebar-toggle-glyph sidebar-toggle-glyph-close" viewBox="0 0 384 512" focusable="false">
