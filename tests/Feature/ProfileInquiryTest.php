...
class ProfileInquiryTest extends TestCase
{
    ...
    public function test_verification_form_has_searchable_profile_choices_and_embedded_id_preview(): void
    {
        ...
        $this->actingAs($user)->get(route('profile.edit'))
            ...
            ->assertSee('sidebar-toggle-glyph-close', false)
            ->assertSee('fa-gauge-high sidebar-nav-icon', false)
            ->assertSee('fa-right-from-bracket sidebar-nav-icon', false)
            ->assertDontSee('sidebar-toggle-arrow', false)
            ...
            ->assertSee('data-address-combobox', false)
            ->assertSee('data-options-id="province-options"', false)
            ->assertDontSee('id="province" name="province" type="search" list=', false)
