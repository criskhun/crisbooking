...
class ProgressiveWebAppTest extends TestCase
{
    ...
    public function test_manifest_and_required_install_assets_are_valid(): void
    {
        ...
        foreach (['sw.js', 'offline.html', 'js/pwa.js', 'css/mobile-shell-v5.css', 'css/mobile-menu-v6.css', 'css/mobile-form-v7.css', 'js/mobile-shell-v5.js', 'icons/icon-192.png', 'icons/icon-512.png', 'icons/icon-maskable-192.png', 'icons/icon-maskable-512.png'] as $asset) {
